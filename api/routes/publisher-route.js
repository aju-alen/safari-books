...
import {publisherCompany,publisherCompanyUpdate,publisherAuthor,getAllAuthorData,getAllCompanyData,getSingleAuthorData,getSingleCompanyData,publishBook,createPostmanBook,publisherAnalytics,generateVoiceSample, updatePublisherRejectField} from '../controllers/publisher-controller.js';
...
router.put('/reject-field', verifyToken, updatePublisherRejectField);
router.get('/get-all-author-data/:userId',getAllAuthorData)
router.get('/get-all-author-data-single/:userId',getSingleAuthorData)
router.get('/publisher-analytics/:userId',verifyToken,publisherAnalytics)
